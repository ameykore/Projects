...
#connect to drone 
connection_string = "127.0.0.1:14558"
print('test')
...
rospy.init_node('heartbit3_talker')
rate = rospy.Rate(10) # 10hz

def heartbit():
	battery = vehicle.battery.voltage
	file = open("/home/amey/swarm_ws/src/swarm/schedule/data3.txt",'r')
	l = file.readline()
	k = float(l.split("=")[1])
	if battery > 10.5:
...
while not rospy.is_shutdown():
	...
	print("sending heartbeat OF ", CONSTANT.DRONE_ID_3)
