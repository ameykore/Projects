...
import endurance3 as ENDURANCE

#connect to drone 
connection_string = "127.0.0.1:14557"
print('test')
...
message = schedule()
rospy.init_node('drone3')
message.Drone_ID = CONSTANT.DRONE_ID_3
...
def talker():
	...
	pub = rospy.Publisher('Drone_ID_3', schedule, queue_size=10)
...
def get_height():
	d = schedule_messsage.Drone_ID.index(CONSTANT.DRONE_ID_3)
...
if __name__ == '__main__':
	while True:
		...
		if CONSTANT.DRONE_ID_3 in schedule_messsage.Drone_ID:
