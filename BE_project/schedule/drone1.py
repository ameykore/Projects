...
import endurance1 as ENDURANCE
...
message.Drone_ID = CONSTANT.DRONE_ID_1
...
def talker():
	...
	pub = rospy.Publisher('Drone_ID_1', schedule, queue_size=10)
...
def get_height():
	d = schedule_messsage.Drone_ID.index(CONSTANT.DRONE_ID_1)
...
if __name__ == '__main__':
	while True:
		...
		if CONSTANT.DRONE_ID_1 in schedule_messsage.Drone_ID:
