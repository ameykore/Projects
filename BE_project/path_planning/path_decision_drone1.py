...
from swarm.msg import path_plan
...
def listening_to_predict_coordinate():
	...
	while path_obj == None:
		rospy.Subscriber("path_planning", path_plan, callback_path)
	time.sleep(1)
	print("done listening...")
...
if __name__ == '__main__':
	...
	print(schedule_id_list)
	if not CONSTANT.DRONE_ID_1 in schedule_id_list :
